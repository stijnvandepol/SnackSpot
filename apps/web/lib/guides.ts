...
export const PILLAR_GUIDES: GuideDefinition[] = [
  {
    href: '/product/guides/add-snackspot-to-home-screen',
  ...
  {
    href: '/product/guides/how-to-add-a-place',

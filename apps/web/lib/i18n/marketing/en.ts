...
export const en: MarketingDict = {
  ...
  community: {
    eyebrow: 'Community',
    title: 'This only works because of people like you',
    body: 'Every gem on SnackSpot was found, photographed and rated by a real person, not an algorithm, not an ad budget. The little bánh mì counter gets discovered because someone took thirty seconds to share it. That someone could be you.',
    tagline: 'Small team, big appetite. Built in the Netherlands, hungry everywhere.',
  ...
  sections: {
    ...
    citiesEyebrow: 'By city',
    citiesTitle: 'Rankings by city',
    citiesBody:
      'Every city with enough photo reviews gets its own ranking, built from what visitors actually ate there. No ads, no sponsored placements.',

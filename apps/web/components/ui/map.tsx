...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "relative rounded-md border bg-white p-3 text-gray-900 shadow-md",
        className
      )}
    >
      {closeButton && (
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center justify-center size-8 hover:bg-gray-100 transition-colors",
  ...
  return (
    <ControlButton onClick={onClick} label="Reset bearing to north">
      ...
      >
        ...
        <path d="M12 22L8 12H12V22Z" className="fill-gray-300" />
      </svg>
    </ControlButton>
  );
}

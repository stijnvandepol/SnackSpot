      ...
      >
        ...
        >
          ...
          <span className="mt-1 block text-sm text-snack-muted">
            A dish at a place, with photos and ratings. Public and permanent — it puts the spot
            on the map and helps others choose.
          </span>
        </Link>
        ...
        >
          ...
          <span className="mt-1 block text-sm text-snack-muted">
            A quick photo of what you&apos;re eating right now. Friends see it for 24 hours,
            then it&apos;s gone from their feed. Keeps your streak alive.
          </span>
        </Link>
      </div>
    </div>

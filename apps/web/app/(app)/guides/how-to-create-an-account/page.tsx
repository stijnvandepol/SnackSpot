    ...
    <div className="mx-auto max-w-5xl px-4 py-10 md:py-14">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'How to Create an Account', path: '/guides/how-to-create-an-account' },
        ]}
      />
      ...
      <article className="guide-content guide-article prose prose-slate">
        ...
        <ol>
          ...
          <li>
            You are signed in immediately. Check your inbox for a verification email and click the link inside to
            confirm your address.
          </li>
        </ol>

        <h2>After creating your account</h2>
        <p>Once signed in you can start using SnackSpot straight away:</p>
        <ul>
          <li>

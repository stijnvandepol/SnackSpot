    ...
    <div className="mx-auto max-w-5xl px-4 py-10 md:py-14">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'How to Change Your Password', path: '/guides/how-to-change-your-password' },
        ]}
      />
      ...
      <article className="guide-content guide-article prose prose-slate">
        ...
        <ol>
          ...
          <li>
            Click <strong>Reset password</strong>. You can now log in with the new password.
          </li>
        </ol>

        <h2>After resetting</h2>
        <p>
          Once your password is changed, go to the <Link href="/auth/login">login page</Link> and sign in with your

...
Plans:
- [x] 03-01-PLAN.md — Photo upload in import route, type extension, UI photo stats box, docker-compose fix
- [x] 03-02-PLAN.md — Round-trip validation script with table counts, photo accessibility, PostGIS checks
